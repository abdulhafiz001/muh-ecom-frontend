          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
                ...
                <span className="block text-yellow-300">Every Need</span>
              </h1>
              <p className="text-xl mb-8 text-blue-100">
                Discover premium perfumes, cosmetics, air fresheners, and household goods 
                from Al-Anwar. Your trusted source for quality and excellence.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Quick and reliable delivery to your doorstep across Nigeria
              </p>
            </div>
